...
class QTN_IMPORT_EXPORT QtnPropertyQFontBase: public QtnSinglePropertyBase<QFont>
{
	Q_OBJECT
...
class QTN_IMPORT_EXPORT QtnPropertyQFontCallback: public QtnSinglePropertyCallback<QtnPropertyQFontBase>
{
	Q_OBJECT
...
class QTN_IMPORT_EXPORT QtnPropertyQFont: public QtnSinglePropertyValue<QtnPropertyQFontBase>
{
	Q_OBJECT
