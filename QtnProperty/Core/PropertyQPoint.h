...
class QTN_IMPORT_EXPORT QtnPropertyQPointBase: public QtnSinglePropertyBase<QPoint>
{
	Q_OBJECT
...
QTN_IMPORT_EXPORT QtnProperty* qtnCreateXProperty(QObject *parent, QtnPropertyQPointBase *propertyPoint);
QTN_IMPORT_EXPORT QtnProperty* qtnCreateYProperty(QObject *parent, QtnPropertyQPointBase *propertyPoint);

class QTN_IMPORT_EXPORT QtnPropertyQPointCallback: public QtnSinglePropertyCallback<QtnPropertyQPointBase>
{
	Q_OBJECT
...
class QTN_IMPORT_EXPORT QtnPropertyQPoint: public QtnSinglePropertyValue<QtnPropertyQPointBase>
{
	Q_OBJECT
