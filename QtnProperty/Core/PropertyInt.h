...
class QTN_IMPORT_EXPORT QtnPropertyIntBase: public QtnNumericPropertyBase<QtnSinglePropertyBase<qint32>>
{
	Q_OBJECT
...
class QTN_IMPORT_EXPORT QtnPropertyIntCallback: public QtnSinglePropertyCallback<QtnPropertyIntBase>
{
	Q_OBJECT
...
class QTN_IMPORT_EXPORT QtnPropertyInt: public QtnSinglePropertyValue<QtnPropertyIntBase>
{
	Q_OBJECT
