...
class QTN_IMPORT_EXPORT QtnPropertyQSizeBase: public QtnSinglePropertyBase<QSize>
{
	Q_OBJECT
...
QTN_IMPORT_EXPORT QtnProperty* qtnCreateWidthProperty(QObject* parent, QtnPropertyQSizeBase* propertySize);
QTN_IMPORT_EXPORT QtnProperty* qtnCreateHeightProperty(QObject* parent, QtnPropertyQSizeBase* propertySize);

class QTN_IMPORT_EXPORT QtnPropertyQSizeCallback: public QtnSinglePropertyCallback<QtnPropertyQSizeBase>
{
	Q_OBJECT
...
class QTN_IMPORT_EXPORT QtnPropertyQSize: public QtnSinglePropertyValue<QtnPropertyQSizeBase>
{
	Q_OBJECT
