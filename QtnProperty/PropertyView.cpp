...
QtnPropertyBase *QtnPropertyView::getPropertyParent(const QtnPropertyBase *property) const
{
...
QtnPropertyView::Item *QtnPropertyView::findItem(Item *currentItem, const QtnPropertyBase *property) const
{
