...
class QtnPropertyUInt64Base: public QtnNumericPropertyBase<QtnSinglePropertyBase<quint64>>
{
	Q_OBJECT
...
class QtnPropertyUInt64Callback: public QtnSinglePropertyCallback<QtnPropertyUInt64Base>
{
	Q_OBJECT
...
class QtnPropertyUInt64: public QtnSinglePropertyValue<QtnPropertyUInt64Base>
{
	Q_OBJECT
...
class QLineEdit;
class QtnPropertyDelegateUInt64: public QObject, public QtnPropertyDelegateTyped<QtnPropertyUInt64Base>
{
	Q_OBJECT
