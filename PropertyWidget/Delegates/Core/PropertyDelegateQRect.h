...
class PropertyQRectBase;

class QTN_PW_EXPORT PropertyDelegateQRect: public PropertyDelegateTypedEx<PropertyQRectBase>
{
    Q_DISABLE_COPY(PropertyDelegateQRect)

public:
    PropertyDelegateQRect(PropertyQRectBase& owner);
